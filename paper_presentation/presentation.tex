...
You can play by changing how your table looks like using the \texttt{kable} command in the \texttt{code\_analysis.Rmd} file.
...
You can play by changing the list of models in the \texttt{code\_analysis.Rmd} file and adding more and more models, changing the scale of the table, etc.
